 ...
 * @since 1.0
 */
public class MongoTenantEntityPersister extends MongoEntityPersister {
    ...
    public MongoTenantEntityPersister(MappingContext mappingContext, PersistentEntity entity,
